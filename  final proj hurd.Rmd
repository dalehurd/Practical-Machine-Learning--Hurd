...
## Data processing
In this section download, process and clean the data.
...
## Cross-validation
In this section create a 75% training subset and a 25% test subset.
...
Quick plot of the "classe" variable.

```{r exploranalysis, echo=TRUE}
plot(table(subTraining$classe), col="orange", main="Levels of the variable classe", xlab="classe levels", ylab="Frequency")
```
